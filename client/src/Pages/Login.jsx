...
const redirectUri = encodeURIComponent(import.meta.env.VITE_OAUTH_REDIRECT || 'https://allinonegbptools.com/OauthCall');
const GOOGLE_AUTH_URL = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${import.meta.env.VITE_CLIENT_ID}&redirect_uri=${redirectUri}&response_type=code&scope=https://www.googleapis.com/auth/business.manage%20openid%20email%20profile&access_type=offline&prompt=consent`;
        ...
        <div className="w-full md:w-[55%] h-[70%] md:h-full bg-white flex flex-col justify-center items-center p-8">
          ...
          <div className="w-full max-w-md">
            <form className="space-y-4" onSubmit={async (e) => {
              ...
              <button type="submit" className="w-full bg-blue-600 text-white py-3 rounded">{loadingLocal ? 'Signing in...' : 'Sign in'}</button>
            </form>
